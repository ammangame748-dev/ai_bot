...
const PRIMARY_MODEL = "llama-3.1-8b-instant"; // سريع وذكي ومتوازن
const FALLBACK_MODELS = ["gemma2-9b-it", "llama-3.3-70b-versatile"];
...
async function getAIResponse(messages, attempt = 0) {
  ...
  try {
    const res = await axios.post("https://api.groq.com/openai/v1/chat/completions", {
      model,
      temperature: 0.5, // توازن بين الذكاء والدقة اللغوية
      top_p: 0.9,
      messages: [
        { 
          role: "system", 
